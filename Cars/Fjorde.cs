...
{
    public class Fjorde : ICar
    {
        public String Make { get; set; } = "Fjorde";
        ...
        public Boolean AddCarFromConsole()
        {
            ...
            { Make = this.Make; Model = model;  Color = color; Description = description; Price = (Decimal)price; Quantity = (Int32)quantity; }
            return true;
